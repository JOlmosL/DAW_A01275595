...
let num = prompt("Ejercicio 1 - Dame un número");
Ejer_1(num);
...
let num2 = prompt("Ejercicio 2 - La respuesta de "+NumRandom1+" + "+NumRandom2+" = ?");
...
function Contador(size)
{
    ...
    {
        Array[i] = prompt("Número a insertar en la posición "+(i+1));
        ...
        else if(Array[i] === 0) //Al quitar el "===", no me funciona el else de abajo...
        {
            CantZeros++;
        }
...
let num3 = prompt("Ejercicio 3 - ¿Cuantos numeros tendría tu arreglo?");
